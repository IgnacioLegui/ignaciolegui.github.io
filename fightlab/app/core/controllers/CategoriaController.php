...
final class CategoriaController extends BaseController implements InterfaceController{
    ...
    public function index(Request $request, Response $response): void{
        array_push($this->scripts, "apps/js/categoria/index.js");
    ...
    public function create(Request $request, Response $response): void{
        array_push($this->scripts, "apps/js/categoria/create.js");
        $this->setCurrentView($request);
        require_once APP_FILE_TEMPLATE;
    }
    ...
    public function edit(Request $request, Response $response): void{
        array_push($this->scripts, "apps/js/categoria/edit.js");
        $this->setCurrentView($request);
        require_once APP_FILE_TEMPLATE;
    }
   ...
   public function update(Request $request, Response $response): void {
        ...
        $response->setMessage("<p>Se actualizó la categoría en el sistema.</p>");
        $response->send();
}
